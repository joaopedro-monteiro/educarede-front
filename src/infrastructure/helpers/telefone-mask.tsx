import './telefone-mask-style.css';
import PropTypes from "prop-types";

const TelefoneBrasileiroInput = (props: any) => {
    const TYPES = {
        OITO: "9999-9999",
        NOVE: "99999-9999",
        SNOVE: "9 9999-9999",
    ...
    return (
        <input placeholder='Telefone' className="inputAntd" {...props} value={value} onChange={onLocalChange} />
    );
};
